...
if __name__ == "__main__":
    ...
    parser.add_argument("type", choices=CASE_TYPES, help=menu_pad + "| Type of foreclosure cases")
    ...
    # ----- optional arguments -----
    # crawling parameters
    parser.add_argument( "-l", "--lower", type=int, default=0, metavar="\b", help="| Lower bound of range of cases" )
    parser.add_argument( "-u", "--upper", type=int, default=0, metavar="\b", help="| Upper bound of range of cases" )
    parser.add_argument( "-f", "--file", metavar="\b", help="| Path of JSON array of cases" )

    # debug mode
    parser.add_argument( "-d", "--debug", action="store_true", help=menu_pad + "| Debug mode" )

    # processing options
    parser.add_argument( "-s", "--scrape", action="store_false", help=menu_pad + "| Scrape only" )
    parser.add_argument( "-m", "--mine", action="store_false", help=menu_pad + "| Mine only" )
    parser.add_argument( "-c", "--clean", action="store_false", help=menu_pad + "| Clean only" )
